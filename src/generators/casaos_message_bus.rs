...
pkgver={}
pkgrel=1
pkgdesc=\"Accepts events and actions from various sources and delivers them to subscribers.\"
arch=('x86_64' 'aarch64' 'armv7h')
url={}
license=('APACHE')
backup=('etc/casaos/casaos-message-bus.conf')
source_x86_64=({})
source_aarch64=({})
source_armv7h=({})
sha256sums_x86_64=({})
...
pub async fn generate_casaos_message_bus_install(
    mut output: tokio::fs::File,
) -> Result<(), Box<dyn std::error::Error>> {
    let pre_install = r#"
pre_install() {
